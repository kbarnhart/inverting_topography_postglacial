...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 07:32:55 2018
...
fig_out = os.path.join(os.path.sep, *['work', 'WVDP_EWG_STUDY3', 'study3py', 'prediction', 'sew' , 'BREACHING', 'topography_figures'])
...
ncs = glob.glob(os.path.join(*['*','*', '*', 'model_**_0100.nc']))
...
def replot(nc):
    ...
    file_parts = nc_full.replace('BREACHING', 'BEST_PARAMETERS').split(os.path.sep)
