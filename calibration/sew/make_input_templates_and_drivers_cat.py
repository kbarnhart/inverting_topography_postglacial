...
driver_template_filepath = os.path.abspath(os.path.join(*(input_template_folderpath+['sew_cat_calibration_model_driver_template.txt'])))
...
#%%
category_file = os.path.join(os.path.abspath(os.sep), *['work', 'WVDP_EWG_STUDY3', 'study3py','auxillary_inputs', 'chi_elev_categories', 'sew.chi_elev_cat.20.txt'])
category_weight_file = os.path.join(os.path.abspath(os.sep), *['work', 'WVDP_EWG_STUDY3', 'study3py','auxillary_inputs', 'weights', 'sew.chi_elev_weight.20.txt'])
...
for model_name in model_dictionary.keys():
    ...
    if type(mid_used[model_name]) == str:
        ...
        input_template_filepath = os.path.abspath(os.path.join(*(input_template_folderpath+['sew_cat_calibration_inputs_template_'+model_name+'.txt'])))
        ...
        # Write model driver
        model_driver_filepath = os.path.abspath(os.path.join(*(driver_folderpath+['sew_cat_calibration_'+model_name+'_driver.py'])))
