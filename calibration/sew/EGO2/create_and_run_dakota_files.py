...
#    this_models_submission_scripts = []
    ...
    for dem_filepath in inital_dems:
        ...
        for lowering_filepath in lowering_histories:
            ...
            if model_name in doubles:
                initial_samples = initial_samples*3
                nnodes = 1
                evaluation_concurrency = (nnodes*24)-1
            else:
                nnodes = 1
        ...
        script_contents = ['#!/bin/sh',
                           ...
                           'if [ -e dakota_calib.rst ]',
                           'then',
                           'dakota -i dakota_hybrid_calibration.in -o dakota_hybrid_calibration.out --read_restart dakota_calib.rst --write_restart dakota_calib.rst &> dakota.log',
                           'else',
                           'dakota -i dakota_hybrid_calibration.in -o dakota_hybrid_calibration.out --write_restart dakota_calib.rst &> dakota.log',
                           'fi']
